import traceback
import sys
from Assignment_2.src.main.Action import Action
from Assignment_2.src.main.State import State
...
class Maze:
    ...
    def __init__(self, file):
        ...
        # The opposite_actions mapping stores the reverse of each action
            ...
            for i in range(1, h + 1):
                ...
                for j in range(0, w):
                    if line[j] != "":
                        ...
                        x += 1
                y += 1
            # self.final_states = [self.states[h - 1][w - 1]]
    ...
    def get_valid_actions(self, agent):
        ...
        # the method checks if surrounding states are "walkable" and if the agent is not going out of the maze
        #  dimensions.
